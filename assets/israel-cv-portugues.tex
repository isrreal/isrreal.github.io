...
computacional, APIs, dados e implantação CPU-only. Sustento decisões com
baselines, ablações, benchmarks e testes automatizados.
...
\begin{itemize}
    ...
    homologação final. Assumi modelos, backend, banco, segurança e implantação;
    a entrega atual possui \textbf{574 testes automatizados}.
    ...
    identificação. A calibração open-set reduziu desconhecidos aceitos de
