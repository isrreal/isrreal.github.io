...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.experience-list li:nth-child(1)', 'Developed machine learning models to investigate characteristics of educational questions and support assessment research.'],
      ['.experience-list li:nth-child(2)', 'Contributed to experiments with textual and visual data, exploring multimodal and multitask approaches.'],
      ['.experience-list li:nth-child(3)', 'Prototyped question-retrieval and ranking solutions to support analysis and research.'],
      ['.experience-list li:nth-child(4)', 'Structured reproducible experiments, evaluations, and technical documentation to support the research cycle.'],
