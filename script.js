...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.hero-description', 'I am <strong>Israel Souza Ferreira</strong>, a data scientist. Statistical modeling, controlled experimentation, and end-to-end MLOps — under one rule: measure before concluding.'],
      ...
      ['#experiencia .experience-layout > div:first-child .lead', 'Applied research in education, plus the individual delivery of a contracted machine learning system.'],
      ...
      ['#fc-exp-lead', 'Face Clock Evoluir: a facial-recognition time-tracking system, delivered end to end and now in final acceptance testing.'],
      ...
      ['#fc-exp-lista li:nth-child(1)', 'Delivered the system on my own: web and kiosk interface, models, data, backend, testing, and deployment.'],
      ['#fc-exp-lista li:nth-child(2)', 'Implemented 1:N vector search and 1:1 verification over 512-dimensional facial embeddings, with liveness and anti-replay protection.'],
      ['#fc-exp-lista li:nth-child(3)', 'Trained an EfficientNet-B0 classifier for medical-document triage and diagnosed its underfitting through controlled ablation.'],
      ...
      ['#competencias .soft-skill-card:nth-child(3) p', 'I record the hypotheses that did not hold, including my own, and revise conclusions when measurement contradicts them.'],
  ...
  'face-clock-tecnico': {
    ...
    content: [
      ...
      ['#congelamento-figura-legenda', 'Accuracy per epoch across the five folds: the classifier-head-only configuration (left) plateaus well below training; the current configuration (right) keeps a much narrower gap between training and validation.'],
    ...
    attributes: [
      ...
      ['#congelamento .case-figure img', 'alt', 'Training and validation accuracy curves by epoch, comparing the configuration that only trains the classifier head with the current configuration that also unfreezes the last two feature blocks.'],
    ],
  },
  'triple-roman': {
