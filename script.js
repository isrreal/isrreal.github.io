...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['#experiencia .experience-layout > div:first-child .lead', 'From psychometric modeling to inference and search services: applied research focused on turning ML prototypes into reproducible multimodal systems.'],
      ...
      ['.experience-facts div:nth-child(1) dd', 'integrated modalities'],
      ['.experience-facts div:nth-child(2) dd', 'simultaneous tasks'],
      ['.experience-facts div:nth-child(3) dt', 'End to end'],
      ['.experience-facts div:nth-child(3) dd', 'from data to inference'],
      ['.experience-list li:nth-child(1)', 'Developed a <strong>multimodal multitask regressor</strong> to estimate psychometric properties of questions: IRT parameters, ICC curve, success rate, knowledge area, competency, and pedagogical skill.'],
      ['.experience-list li:nth-child(2)', 'Built an end-to-end pipeline integrating text, optional images, and a <strong>supervised reasoning channel</strong> produced with local LLMs and DSPy, using masks to handle missing modalities.'],
      ['.experience-list li:nth-child(3)', 'Aligned heterogeneous representations with <strong>RelRep</strong> and anchor-selection strategies, combining textual and visual embeddings before multimodal fusion.'],
      ['.experience-list li:nth-child(4)', 'Implemented and compared configurable reducers—from pooling and gated fusion to attention, <i>cross-attention</i>, recurrence, and residual connections—on a MoE/MMoE architecture with experts and task-specific gates.'],
      ['.experience-list li:nth-child(5)', 'Designed a robust multitask training process with weighted losses, staged warm-up, gradient control, learning-rate scheduling, early stopping, mixed precision, and checkpoint resumption.'],
      ['.experience-list li:nth-child(6)', 'Delivered a <strong>multimodal top-k search API</strong> with FastAPI, RelRep, BERTScore, and FAISS for question retrieval and ranking.'],
      ['.experience-list li:nth-child(7)', 'Organized inference, experiments, and consistency checks into a reproducible workflow with PyTorch, FastAPI, Docker, Git, and GitLab CI/CD.'],
      ['.experience-evaluation h4', 'How the regressor is evaluated'],
      ['.experience-evaluation > p:first-of-type', 'The evaluation protocol tracks each output with metrics suited to its type instead of reducing different tasks to a single indicator.'],
      ['.experience-metric-grid li:nth-child(1) strong', 'Psychometric regression'],
      ['.experience-metric-grid li:nth-child(1) span', 'MAE and R² for the IRT parameters and success rate, plus Pearson correlation for <i>a</i>, <i>b</i>, and <i>c</i>.'],
      ['.experience-metric-grid li:nth-child(2) strong', 'ICC curve'],
      ['.experience-metric-grid li:nth-child(2) span', 'MAE, per-question R², and NLL to evaluate curve reconstruction and probabilistic calibration.'],
      ['.experience-metric-grid li:nth-child(3) strong', 'Pedagogical classification'],
      ['.experience-metric-grid li:nth-child(3) span', 'Accuracy and macro F1 for knowledge area, competency, and skill, accounting for class imbalance.'],
      ['.experience-evaluation .evaluation-note', 'Metrics are monitored per task and through a multitask validation score. Performance values will be published after testing is complete.'],
