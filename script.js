...
const englishPages = {
  home: {
    ...
    description: 'Portfolio of Israel Souza Ferreira — a data scientist and machine learning engineer working across experimentation, computer vision, and production ML systems.',
    content: [
      ...
      ['.hero .eyebrow', 'Data Science · ML Engineering · Experimentation'],
      ['.hero h1', 'I turn models into decisions and systems that work beyond the notebook.'],
      ['.hero-description', 'I am <strong>Israel Souza Ferreira</strong>, a data scientist and machine learning engineer. I investigate problems, test hypotheses, and take models into production — with metrics, reproducible code, and ownership of the outcome.'],
      ['.hero-quote', 'My working principle: measure before concluding, and change direction when the data contradicts the hypothesis.'],
      ['.first-impression-card .section-kicker', 'In 20 seconds'],
      ['.first-impression-card h2', 'Applied research with production delivery.'],
      ['.proof-list li:nth-child(1)', '<strong>End-to-end ML:</strong> data, models, APIs, tests, and deployment.'],
      ['.proof-list li:nth-child(2)', '<strong>Evidence-driven decisions:</strong> baselines, ablations, paired tests, and benchmarks.'],
      ['.proof-list li:nth-child(3)', '<strong>Engineering under constraints:</strong> CPU-only inference, 8&nbsp;GB of RAM, and a 9.5× smaller delivery.'],
      ['.first-impression-card .text-link', 'See evidence in the projects →'],
      ['.impact-grid article:nth-child(1) span', 'automated tests in the latest delivery'],
      ['.impact-grid article:nth-child(2) span', 'p95 facial identification on CPU, one request'],
      ['.impact-grid article:nth-child(3) span', 'of public data in the ingestion pipeline'],
      ['.impact-grid article:nth-child(4) span', 'unknown people accepted after threshold calibration*'],
      ['.impact-note', '* Measured on a public reference population; final calibration must be repeated on the real database.'],
      ['#sobre .section-kicker', 'Choose the depth'],
      ['#sobre h2', 'A portfolio for three reading times.'],
      ['#sobre .lead', 'Start with impact. Go deeper only where it matters.'],
      ['.reading-path li:nth-child(1) > span', '01 · 30 seconds'],
      ['.reading-path li:nth-child(1) > strong', 'Results'],
      ['.reading-path li:nth-child(1) p', 'Numbers and deliveries for a quick view of my profile.'],
      ['.reading-path li:nth-child(1) a', 'See experience →'],
      ['.reading-path li:nth-child(2) > span', '02 · 3 minutes'],
      ['.reading-path li:nth-child(2) > strong', 'Case studies'],
      ['.reading-path li:nth-child(2) p', 'Problem, decision, and impact in business language.'],
      ['.reading-path li:nth-child(2) a', 'See projects →'],
      ['.reading-path li:nth-child(3) > span', '03 · deep dive'],
      ['.reading-path li:nth-child(3) > strong', 'Experiments and engineering'],
      ['.reading-path li:nth-child(3) p', 'Protocols, baselines, benchmarks, architecture, and limitations.'],
      ['.reading-path li:nth-child(3) a', 'Open technical page →'],
      ['#experiencia .experience-layout > div:first-child h2', 'From problem to operation.'],
      ['#experiencia .experience-layout > div:first-child .lead', 'Applied research, experimentation, and end-to-end ML systems.'],
      ['.experience-stack .experience-card:nth-child(1) h3', 'R&amp;D Researcher — document segmentation'],
      ['.experience-stack .experience-card:nth-child(1) .experience-company', 'Tieta Artificial Intelligence · Remote'],
      ['.experience-stack .experience-card:nth-child(1) .experience-period', 'Jul 2026 — present'],
      ['.experience-stack .experience-card:nth-child(1) .experience-facts div:nth-child(1) dt', 'OCR'],
      ['.experience-stack .experience-card:nth-child(1) .experience-facts div:nth-child(1) dd', 'scanned exams'],
      ['.experience-stack .experience-card:nth-child(1) .experience-facts div:nth-child(2) dt', 'Vision'],
      ['.experience-stack .experience-card:nth-child(1) .experience-facts div:nth-child(2) dd', 'question segmentation'],
      ['.experience-stack .experience-card:nth-child(1) .experience-facts div:nth-child(3) dt', 'Pipeline'],
      ['.experience-stack .experience-card:nth-child(1) .experience-facts div:nth-child(3) dd', 'structured output'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li', 'Building a pipeline that segments questions from scanned exams and delivers structured items for educational analysis.'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(1)', 'OCR'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(2)', 'Computer Vision'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(3)', 'Document Segmentation'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(4)', 'Python'],
      ['.experience-stack .experience-card:nth-child(2) h3', 'Data Scientist / R&amp;D — applied education research'],
      ['.experience-stack .experience-card:nth-child(2) .experience-company', 'Tieta Artificial Intelligence · CNPq RHAE Fellow'],
      ['.experience-stack .experience-card:nth-child(2) .experience-period', 'Apr 2025 — Jun 2026'],
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(1)', 'Modeled psychometric parameters with IRT and compared multitask architectures through paired evaluations, ablations, and inference cost.'],
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(2)', 'Built signal-extraction pipelines with LLMs orchestrated through DSPy.'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(1)', 'IRT'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(2)', 'Statistics'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(3)', 'PyTorch'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(4)', 'DSPy'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(5)', 'LLMs'],
      ['#fc-exp-lead', 'Contracted attendance system with facial recognition, medical-document triage, and CPU-only operation on constrained hardware.'],
      ...
      ['#fc-exp-lista li:nth-child(1)', 'Owned models, backend, database, security, tests, packaging, and deployment.'],
      ['#fc-exp-lista li:nth-child(2)', 'Measured threshold, frame count, vector search, and concurrency before changing the architecture.'],
      ['#fc-exp-lista li:nth-child(3)', 'Reduced delivery images from 10.59&nbsp;GB to 1.11&nbsp;GB while preserving classifier decisions.'],
      ['.experience-teaser', '* One concurrent identification; at 20, p95 is 1.87&nbsp;s. The case study separates impact, decisions, and reproducible evidence.'],
      ['#projetos .project-card:nth-child(1) .status', 'Final acceptance testing'],
      ['#projetos .project-card:nth-child(1) .project-overline', 'Flagship project · Production ML'],
      ['#projetos .project-card:nth-child(1) h3', 'Face Clock Evoluir'],
      ['#projetos .project-card:nth-child(1) .project-flagship-grid > div > p:not(.project-overline)', 'Facial-recognition attendance system delivered to an educational institution, with medical-document triage, employment rules, security, and CPU-only deployment.'],
      ['#projetos .project-card:nth-child(1) .project-evidence div:nth-child(1) dd', 'open-set false acceptance after threshold calibration*'],
      ['#projetos .project-card:nth-child(1) .project-evidence div:nth-child(2) dd', 'same measured accuracy; less redundant work'],
      ['#projetos .project-card:nth-child(1) .project-evidence div:nth-child(3) dd', 'exact search over 1,000 vectors; FAISS was not justified'],
      ['#projetos .project-card:nth-child(1) .project-evidence div:nth-child(4) dd', 'with two simultaneous clock-ins; race found and fixed'],
      ['#projetos .project-card:nth-child(1) .project-links a:nth-child(1)', 'Understand the impact <span class="card-link-arrow" aria-hidden="true">→</span>'],
      ['#projetos .project-card:nth-child(1) .project-links a:nth-child(2)', 'See experiments →'],
      ['#projetos .project-card:nth-child(1) .project-links a:nth-child(3)', 'Public repository →'],
      ['#projetos .project-card:nth-child(1) .project-footnote', '* Public reference population; the technical study states the protocol and limitation.'],
      ...
      ['#projetos .project-card:nth-child(2) .project-links a:nth-child(1)', 'Explore project <span class="card-link-arrow" aria-hidden="true">→</span>'],
      ['#projetos .project-card:nth-child(2) .project-links a:nth-child(2)', 'View technical breakdown →'],
      ...
      ['#projetos .project-card:nth-child(3) > p', 'Chunked ingestion through binary <code>COPY</code> over 31.6&nbsp;GB of public data; instrumentation tied memory growth to retained deduplication identifiers (r = 0.99).'],
      ['#projetos .project-card:nth-child(3) .project-links a', 'Code and documentation →'],
      ['#experiencia-face-clock .tag-list li:nth-child(1)', 'YuNet + SFace'],
      ['#projetos .project-card:nth-child(1) .tag-list li:nth-child(1)', 'Computer Vision'],
      ['#projetos .project-card:nth-child(1) .tag-list li:nth-child(2)', 'ONNX Runtime'],
      ['#projetos .project-card:nth-child(1) .tag-list li:nth-child(3)', 'FastAPI'],
      ['#projetos .project-card:nth-child(1) .tag-list li:nth-child(4)', 'PostgreSQL'],
      ['#projetos .project-card:nth-child(1) .tag-list li:nth-child(5)', 'pgvector'],
      ['#projetos .project-card:nth-child(1) .tag-list li:nth-child(6)', 'Docker'],
    ],
    attributes: [
      ['nav', 'aria-label', 'Main navigation'],
      ['.brand', 'aria-label', 'Home page'],
      ['.hero-meta', 'aria-label', 'Professional information'],
      ['.first-impression-card', 'aria-label', 'Professional summary in twenty seconds'],
  ...
  'face-clock': {
    ...
    content: [
      ...
      ['#resumo .case-list li:nth-child(2)', '<strong>Responsibility:</strong> models, backend, data, security, testing, and deployment.'],
      ...
      ['#resumo .case-list li:nth-child(4)', '<strong>Evidence:</strong> 574 tests; four facial-recognition decisions measured; five medical-document classifiers compared; production package audited.'],
      ...
      ['#qualidade .case-result:nth-child(1) span', 'automated tests passing in the Docker pipeline'],
      ['#status .case-prose p:nth-child(1)', 'The system is functional and undergoing final acceptance testing before deployment at the institution.'],
      ['footer .text-link', 'Back to portfolio'],
    ],
    attributes: [
      ['nav', 'aria-label', 'Main navigation'],
  ...
  'face-clock-tecnico': {
    ...
    content: [
      ...
      ['#entrega h2', 'The production server had no GPU.'],
      ...
      ['.face-tech-hero .case-meta li:nth-child(5)', 'Security and production'],
      ...
      ['#reconhecimento-reproducao', 'Reproduction lives in notebooks 15–18 and <code>ml/face_bench.py</code>: the same extraction, normalization, and thresholds used by the production service, with data sources and limitations stated.'],
      ['footer .text-link', 'Back to portfolio'],
    ],
    attributes: [
      ['nav', 'aria-label', 'Main navigation'],
