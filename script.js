...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['#competencias .soft-skills .section-kicker', 'Engineering principles'],
  ...
  'face-clock': {
    ...
    content: [
      ...
      ['#resumo .case-list li:nth-child(3)', '<strong>Architecture:</strong> facial biometrics with 512-dimensional embeddings and vector search in PostgreSQL with <code>pgvector</code>, GPS geofencing, medical-document triage combining a CNN with OCR, and a FastAPI backend running in Docker.'],
      ['#resumo .case-list li:nth-child(4)', '<strong>Evidence:</strong> 142 automated tests in a Docker pipeline; 468 documents triaged by objective quality signals; an image-orientation fix and reduced <em>augmentation</em> that raised validation accuracy by thirteen percentage points.'],
