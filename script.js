...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['#projetos .project-card:nth-child(2) > p', 'Time-series forecasting of dengue case notifications by state, with ETL over Brazilian SINAN microdata, tracked experimentation, and an inference service. RMSE reduced from ≈98 to 83 on the Ceará series (≈15% drop).'],
