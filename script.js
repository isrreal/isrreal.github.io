...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.hero h1', 'I build machine learning systems and measure whether they actually work.'],
      ['.hero-description', 'I am <strong>Israel Souza Ferreira</strong>, a machine learning researcher with hands-on experience in multimodal systems, information retrieval, time-series forecasting, and end-to-end MLOps. What sets me apart is evaluation: measure before concluding, and distrust your own result.'],
      ...
      ['.experience-facts div:nth-child(2) dd', 'from prototype to evaluation'],
      ['.experience-facts div:nth-child(3) dt', 'Collaboration'],
      ['.experience-facts div:nth-child(3) dd', 'in a research setting'],
      ['.experience-list li:nth-child(1)', 'Modeled characteristics of educational questions with Item Response Theory, validating model-estimated signals against reference psychometric parameters.'],
      ['.experience-list li:nth-child(2)', 'Built inference pipelines with language models orchestrated by DSPy, including procedural dialogue generation and cognitive-trajectory tracking.'],
      ['.experience-list li:nth-child(3)', 'Compared alternative approaches through paired evaluation on the same items, measuring both the correlation of the resulting signals with reference parameters and the inference cost of each.'],
      ['.experience-list li:nth-child(4)', 'Experimented with relative representations and attention-based reducers in multitask regression architectures over textual and visual data.'],
      ['.experience-list li:nth-child(5)', 'Structured reproducible experiments, evaluations, and technical documentation to support the research cycle.'],
      ...
      ['#projetos .project-card:nth-child(4) .status', 'In development'],
      ['#projetos .project-card:nth-child(4) h3', 'Brazilian Emergency Aid — Ingestion and performance experiments'],
      ['#projetos .project-card:nth-child(4) > p', 'Picked back up on my own initiative after the academic submission. Chunked ingestion through binary <code>COPY</code> over 31.6 GB of public data; instrumentation tied memory growth to retained deduplication identifiers (r = 0.99).'],
      ...
      ['#competencias .soft-skill-card:nth-child(1) p', 'Diagnosing a classifier that would not learn, I ruled out three candidate causes through controlled experiments — one variable at a time, with a control group.'],
      ['#competencias .soft-skill-card:nth-child(2) h3', 'Structured problem-solving'],
      ['#competencias .soft-skill-card:nth-child(2) p', 'I traced a silent OCR failure to an orientation metadata tag the imaging library ignored. Nothing appeared in the logs — only unreadable text.'],
      ['#competencias .soft-skill-card:nth-child(3) h3', 'Skepticism toward my own results'],
      ['#competencias .soft-skill-card:nth-child(3) p', 'A signal reported rotation across 45% of a dataset. Cross-checked against file type, 91 of 109 cases were false positives from the detector, not a property of the data.'],
      ['#competencias .soft-skill-card:nth-child(4) h3', 'Technical communication'],
      ['#competencias .soft-skill-card:nth-child(4) p', 'I document experiments alongside the numbers that support them, including negative results and conclusions that had to be revised once measured.'],
      ['#competencias .soft-skill-card:nth-child(5) h3', 'Self-directed learning'],
      ['#competencias .soft-skill-card:nth-child(5) p', 'I learn the fundamentals a decision requires — from information theory to model calibration — when choosing the right instrument depends on understanding it.'],
      ['#competencias .soft-skill-card:nth-child(6) h3', 'Willingness to cut scope'],
      ['#competencias .soft-skill-card:nth-child(6) p', 'I removed 2,071 lines from an experiment I had built myself, after concluding its premise did not hold.'],
  ...
  'face-clock': {
    ...
    content: [
      ...
      ['#diagnostico .case-result:nth-child(3) span', 'percentage points of validation accuracy gained once the experiment isolated the real cause'],
      ...
      ['#diagnostico .case-list li:nth-child(5)', '<strong>The earlier conclusion, invalidated by the fix itself:</strong> while the classifier was stuck, measurement indicated it contributed almost nothing — the OCR carried the result alone. Re-running the same evaluation after the fix reversed the picture: the network began crossing the decision threshold on 19.7% of documents against 0.6% before, agreement between the two components moved from chance level to moderate, and the squared error of the probabilities halved. The conclusion held for the defective model, not for the problem. Because the evaluation instruments were already in place, re-checking cost a re-run, with no new code.'],
