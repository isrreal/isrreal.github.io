...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.hero h1', 'Rigorously evaluated models. Production-ready ML systems.'],
      ['.hero-description', 'I am <strong>Israel Souza Ferreira</strong>. I work across modeling, experimentation, and engineering — from reproducible baselines to APIs and production inference.'],
      ...
      ['.first-impression-card h2', 'Data Scientist + ML Engineer'],
      ['.proof-list li:nth-child(1)', '<strong>Modeling:</strong> statistics, IRT, PyTorch, and experimental evaluation.'],
      ['.proof-list li:nth-child(2)', '<strong>Production:</strong> computer vision, APIs, PostgreSQL, Docker, and CI.'],
      ...
      ['#experiencia .experience-layout > div:first-child h2', 'Applied research and production ML.'],
      ...
      ['#fc-exp-lead', 'Delivered a contracted facial-attendance and medical-document triage system, from modeling to CPU-only deployment.'],
      ...
      ['#projetos .project-card:nth-child(1) > p:not(.project-overline)', 'Facial-attendance system delivered to an educational institution. I owned models, backend, data, security, tests, packaging, and deployment.'],
      ...
      ['#projetos .project-card:nth-child(2) > p', 'The first published GA- and ACO-based metaheuristics for the TRDP and a corrected ILP formulation, evaluated over 362 graphs.'],
      ...
      ['#competencias .skill-group:nth-child(4) h3', 'Production and MLOps'],
      ['#competencias .skill-group:nth-child(4) p', 'FastAPI, PostgreSQL, pgvector, ONNX Runtime, Docker, CI, pytest, MLflow'],
      ...
      ['#contato .contact-card > div:first-child > p:last-child', 'Open to Data Science and ML Engineering opportunities.'],
