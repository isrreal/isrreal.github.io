...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.experience-stack .experience-card:nth-child(1) .lead', 'I work on software development and evolution to support research and innovation activities.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(1)', 'Contributed to software development and maintenance in research and innovation activities.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(2)', 'Implemented validation and automated tests to support software quality and maintenance.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(3)', 'Automated technical activities to support reproducibility and work organization.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(4)', 'Produced technical documentation and organized changes through version control for traceability, governance, and controlled evolution.'],
      ...
      ['.experience-stack .experience-card:nth-child(2) h3', 'Machine Learning Researcher — applied research'],
      ...
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(1)', 'Conducted applied Machine Learning research, developing and evaluating computational solutions.'],
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(2)', 'Performed experimentation and results analysis to support technical evaluation and decision-making.'],
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(3)', 'Established reproducible development and evaluation processes to organize research activities.'],
