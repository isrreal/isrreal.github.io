...
const englishPages = {
  ...
  'face-clock': {
    ...
    content: [
      ...
      ['.state-main-flow .state-node:nth-child(1)', 'No punch'],
      ['.state-main-flow .state-node:nth-child(3)', 'Clock-in'],
      ['.state-main-flow .state-node:nth-child(5)', 'Break begins'],
      ['.state-main-flow .state-node:nth-child(7)', 'Return'],
      ['.state-main-flow .state-node:nth-child(9)', 'Clock-out'],
      ['.state-retry-flow .state-node:nth-child(2)', 'Clock-in'],
      ['.state-retry-flow .state-node:nth-child(4)', 'Clock-out'],
      ['.state-retry-flow .state-return', 'direct exit'],
      ['.state-extra-flow .state-node:nth-child(2)', 'Return'],
      ['.state-extra-flow .state-node:nth-child(4)', 'Break begins'],
      ['.state-extra-flow .state-return', 'another break'],
