...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.experience-stack .experience-card:nth-child(2) .experience-list li', 'Modeled psychometric parameters with IRT and evaluated multitask architectures through paired tests, ablations, and inference cost; also built LLM pipelines with DSPy.'],
