...
const englishPages = {
  ...
  'face-clock': {
    ...
    content: [
      ...
      ['#maquina-estados .case-prose p:nth-child(2)', 'After facial authentication and location validation, <code>PontoFSM</code> resolves the next action: you can clock out right after clocking in, take breaks, and only end the shift after a valid return.'],
      ['#fsm-empty-line-1', 'No'],
