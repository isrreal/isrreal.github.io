...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.experience-stack .experience-card:nth-child(1) .experience-list li', 'Building an OCR and computer-vision pipeline that turns scanned exams into structured questions.'],
