...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['#experiencia .experience-layout > div:first-child .lead', 'Statistical modeling and experimentation applied to research in education, plus the individual delivery of a machine learning system contracted by an educational institution.'],
      ...
      ['.experience-list li:nth-child(2)', 'Designed paired evaluations over the same items to compare competing approaches under the same protocol, quantifying both the correlation of each estimated signal with reference parameters and its inference cost.'],
      ['.experience-list li:nth-child(3)', 'Built signal-extraction pipelines with language models orchestrated by DSPy.'],
      ['.experience-list li:nth-child(4)', 'Tested multitask regression architectures over textual and visual data.'],
      ...
      ['#fc-exp-lista li:nth-child(1)', 'Delivered the contracted system on my own, covering the web and kiosk interface, modeling, the data layer, the backend, testing, and deployment.'],
  ...
  'face-clock': {
    ...
    content: [
      ...
      ['#atestado-resumo', 'Triage does not decide on its own: it organizes the queue and flags what looks out of place, and the final word still belongs to a person. Evaluated on documents the model had never seen, the chosen version gets 87.5% of the cases right and makes seven fewer mistakes than the previous alternative, without recognizing fewer certificates than it did.'],
      ...
      ['#ponte-lead', 'Every number on this page came from a measurement, and none of them fits in a summary. The technical page documents the comparison between classification approaches, the diagnosis of a silent bug, the experiments that isolated the cause of the model’s underfitting, and the application’s security layers.'],
      ['#ponte-aviso', 'It is optional reading, written for whoever wants to see the method: evaluation protocol, result tables, and discarded hypotheses — including my own.'],
  ...
  'face-clock-tecnico': {
    ...
    content: [
      ...
      ['.case-hero .hero-actions a:nth-child(3)', 'See engineering and security'],
  ...
  'triple-roman': {
    ...
    content: [
      ...
      ['#trd-variacao-lead', 'Constantine’s idea became a mathematical problem in 2004, and has since gained increasingly demanding versions. Only one thing changes: how many legions of relief each region must gather.'],
      ['#trd-var1-tag', '2004'],
      ['#trd-var1-titulo', 'Roman domination'],
      ['#trd-var1-texto', 'One legion of relief per region. A single strong neighbour is enough to cover whoever sits ungarrisoned.'],
      ['#trd-var2-tag', '2016'],
      ['#trd-var2-titulo', 'Double Roman domination'],
      ['#trd-var2-texto', 'Two legions of relief. One ordinary neighbour no longer suffices: more reinforcement is needed around it.'],
      ['#trd-var3-tag', '2021 · this work'],
      ['#trd-var3-titulo', 'Triple Roman domination'],
      ['#trd-var3-texto', 'Three legions of relief. It is the most demanding of the three and, because of that, the one that tolerates the largest number of simultaneous failures.'],
      ['#trd-var4-tag', 'The trade-off'],
      ['#trd-var4-titulo', 'More robust, not cheaper'],
      ['#trd-var4-texto', 'Requiring three instead of one costs more legions — the solution gets more expensive. The gain is not economy: it is the margin to absorb simultaneous attacks or outages without leaving anyone uncovered.'],
      ...
      ['#trd-dificuldade-texto', 'With eight regions there are 65,536 distributions. With a hundred regions the count has 61 digits — <strong>billions of times every atom on Earth</strong>. A computer testing a billion of them per second since the Big Bang would have covered a negligible fraction. And the problem is <strong>NP-complete</strong>: no exact and fast method is known, and the field suspects none exists. What is left is finding good solutions in acceptable time.'],
      ...
      ['#trd-aplicacoes-lead', 'Swap the regions for neighbourhoods and the legions for warehouses. How many warehouses does a chain need, and in which neighbourhoods, to supply the whole city — knowing that a warehouse covering its neighbour cannot run out of its own stock? It is the same arithmetic Constantine did.'],
      ['#trd-cidade-kicker', 'The same statement, in three readings'],
      ['#trd-cidade-texto', '<strong>A neighbourhood without a warehouse has to be supplied by its neighbours — and whoever supplies it still has something left to sell.</strong> Swap the words: server, antenna, hospital, on-call team. The structure of the problem does not change.'],
      ['#trd-aplicacao-1', '<strong>Stores and warehouses:</strong> how many stock points a chain needs to cover every neighbourhood, including those without a store of their own, without starving whoever comes to the rescue.'],
      ['#trd-aplicacao-2', '<strong>Servers and antennas:</strong> where to place them, and how many, so the whole network stays served when one point goes down — and stays served if two go down together.'],
      ['#trd-aplicacao-3', '<strong>Teams and on-call rosters:</strong> spreading ambulances, fire brigades, or maintenance crews across regions that can cover one another without leaving themselves uncovered.'],
      ['#trd-aplicacoes-nota', 'The literature cites military defence, server allocation, and network coverage; the store and on-call examples are analogies meant to expose the structure. The work itself is about the mathematical problem: there is no applied case study over a real network here.'],
