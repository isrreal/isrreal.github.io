...
const englishPages = {
  home: {
    ...
    content: [
      ...
      ['.first-impression-card .section-kicker', '20-second profile'],
      ['.first-impression-card h2', 'Data Science · ML Engineering · Applied ML'],
      ...
      ['.proof-list li:nth-child(3)', '<strong>Edge:</strong> decisions backed by baselines, ablations, and benchmarks.'],
      ['.first-impression-card .text-link', 'See experience →'],
      ['.impact-grid article:nth-child(1) span', 'automated tests in the Face Clock system'],
      ['.impact-grid article:nth-child(2) span', 'p95 facial identification on CPU, one request'],
      ['.impact-grid article:nth-child(3) span', 'graphs evaluated in the combinatorial-optimization thesis'],
      ['.impact-note', '* Benchmark on public data and in a controlled environment; calibration and operational validation still depend on the context of use.'],
      ...
      ['#experiencia .experience-layout > div:first-child h2', 'Applied research and ML-enabled systems engineering.'],
      ['#experiencia .experience-layout > div:first-child .lead', 'What I did, where, and with which results.'],
      ['.experience-stack .experience-card:nth-child(1) h3', 'R&amp;D Researcher — document segmentation'],
      ['.experience-stack .experience-card:nth-child(1) .experience-company', 'Tieta.ai · Remote'],
      ['.experience-stack .experience-card:nth-child(1) .experience-period', 'Jul 2026 — present'],
      ['.experience-stack .experience-card:nth-child(1) .lead', 'I develop Python pipelines to turn exam OCR output into structured, auditable educational questions for downstream processing.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(1)', 'Developed and evolved deterministic segmentation with lexical and syntactic analysis, handling formatting variations and recovering from OCR errors while preserving question text, answer options, and visual elements.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(2)', 'Implemented an API with FastAPI to integrate processing results and enrich documents in search/indexing systems, with validation and audits of inconsistencies across data sources.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(3)', 'Automated reproducible runs and reuse of previously processed artifacts, with report generation, automated and regression tests, structural validation, and diagnostics for manual review.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(4)', 'Produced workflow documentation, benchmarks, technical reports, experiment records, and audit artifacts to support traceability, technical governance, knowledge organization, maintenance, and decision-making.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(5)', 'Organized changes using version control practices to maintain a clear technical history, compare approaches, track regressions, and support experiment reproduction and controlled pipeline evolution.'],
      ['.experience-stack .experience-card:nth-child(1) .experience-list li:nth-child(6)', 'Worked with DSPy and LanguageTool on textual content enrichment, review, and validation.'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(1)', 'Python'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(2)', 'OCR'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(3)', 'Structural Validation'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(4)', 'FastAPI'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(5)', 'Elasticsearch'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(6)', 'DSPy'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(7)', 'LanguageTool'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(8)', 'Docker'],
      ['.experience-stack .experience-card:nth-child(1) .tag-list li:nth-child(9)', 'Computer Vision'],
      ['.experience-stack .experience-card:nth-child(2) h3', 'Machine Learning Researcher — applied education research'],
      ...
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(1)', 'Developed and evaluated multimodal, multitask models to estimate psychometric characteristics of educational questions from text and images.'],
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(2)', 'Modeled parameters with IRT and compared architectures through baselines, ablations, paired tests, and statistical analysis, identifying complexity without consistent gains.'],
      ['.experience-stack .experience-card:nth-child(2) .experience-list li:nth-child(3)', 'Built LLM pipelines with DSPy for structured analyses and investigated text--image semantic retrieval as an auxiliary signal.'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(1)', 'IRT'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(2)', 'PyTorch'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(3)', 'Multimodal ML'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(4)', 'Experimentation'],
      ['.experience-stack .experience-card:nth-child(2) .tag-list li:nth-child(5)', 'LLMs + DSPy'],
      ...
      ['#fc-exp-lead', 'Developed a contracted facial-attendance and medical-document triage system, from modeling to packaging for CPU-only deployment.'],
      ...
      ['#projetos .section-heading h2', 'Cases with impact, method, and code.'],
      ['#projetos .section-heading .text-link', 'All repositories →'],
      ['#projetos .project-card:nth-child(1) .status', 'Final acceptance testing'],
      ['#projetos .project-card:nth-child(1) .project-overline', 'Flagship project · Applied ML system under acceptance testing'],
      ['#projetos .project-card:nth-child(1) h3', 'Face Clock Evoluir'],
      ['#projetos .project-card:nth-child(1) > p:not(.project-overline)', 'Facial-attendance system developed for an educational institution and under final acceptance testing. I owned models, backend, data, security, tests, and packaging for deployment.'],
      ...
      ['#projetos .project-card:nth-child(2) > p', 'Combinatorial-optimization thesis: implemented GA and ACO metaheuristics and proposed a corrected ILP formulation, evaluated over 362 graphs.'],
      ...
      ['#competencias h2', 'Stack by stage of the ML lifecycle.'],
      ['#competencias .lead', 'Skills used in projects, not just keywords.'],
      ...
      ['#competencias .skill-group:nth-child(4) h3', 'Application engineering and delivery'],
      ...
      ['#curriculo h2', 'A one-page professional résumé.'],
      ['#curriculo .contact-card > div:first-child > p:last-child', 'Experience, results, projects, education, and stack. Lattes contains the full academic record.'],
  ...
  'face-clock': {
    ...
    content: [
      ...
      ['#face-case-intro', 'A contracted attendance system for an educational institution: it identifies employees by face, validates the clock-in context, and triages medical documents submitted by phone.'],
      ['#face-case-depth', 'Start with the impact, then review the decisions and, if useful, open the <a href="tecnico.html#reconhecimento">reproducible experiments</a>.'],
      ...
      ['.flow-step:nth-child(1) p', 'Three frames support liveness without retaining redundant work.'],
      ...
      ['#evidencias article:nth-child(1) p', 'The inherited threshold came from 1:1 verification; in the 1:N setting it accepted too many unknown people. Calibration reduced this error by two orders of magnitude on the reference data.'],
      ['#evidencias article:nth-child(2) span', 'Latency'],
      ['#evidencias article:nth-child(2) p', 'Measured accuracy was unchanged from one to eight frames. Three preserve the median and motion check without paying for two extra frames.'],
      ['#evidencias article:nth-child(3) span', 'Architecture'],
      ['#evidencias article:nth-child(3) strong', 'FAISS: not adopted'],
      ['#evidencias article:nth-child(3) p', 'Exact search took 0.076&nbsp;ms over 1,000 vectors. HNSW was faster, but recall@1 of 0.915 did not justify trading precision for complexity.'],
      ['#evidencias article:nth-child(4) span', 'Concurrency'],
      ['#evidencias article:nth-child(4) p', 'Two simultaneous clock-ins corrupted the shared model. Measurement exposed the race; serializing inference eliminated the silent failure.'],
      ['#evidencias .evidence-ladder-link', 'See protocols, tables, and limitations →'],
      ['#atestado-lead', 'When a medical document is submitted, computer vision and OCR check whether it is likely to be a certificate before it reaches the reviewer.'],
      ['#atestado-resumo', 'Triage organizes the queue; a person makes the final decision. On unseen documents, the selected model reached 87.5% accuracy and made seven fewer false positives than the prior version at the same recall.'],
      ['#atestado-rotulos', 'Human decisions may feed retraining. Rejected documents only become negative examples when reviewer and model agree.'],
      ['#qualidade .case-prose > p', 'I installed and audited the package exactly as the client would receive it. That exposed incorrect volume permissions and a packaged model that differed from the validated one — failures invisible to tests run only against the working tree.'],
      ['#qualidade .case-result:nth-child(1) span', 'automated tests passing in the Docker pipeline'],
      ['#status .case-prose p:nth-child(1)', 'The contracted system is functional and in final validation before deployment; it is not presented as a production-operated system.'],
      ['footer .text-link', 'Back to portfolio'],
    ],
    attributes: [
      ['nav', 'aria-label', 'Main navigation'],
  ...
  'face-clock-tecnico': {
    ...
    content: [
      ...
      ['.case-intro', 'This page documents what supports the numbers in the case study: how each classification approach was compared under the same protocol, how a silent bug was diagnosed, how the cause of the model’s underfitting was isolated by experiment, how the application is protected in layers, how five interface defects escaped a green suite and a clean console, and how the whole stack was resized for a server with no graphics card.'],
      ...
      ['#congelamento-lead', 'The unfreezing configuration selected for delivery looked like it was overfitting: 97% training accuracy against 70% on a test set of only 40 images. Instead of accepting that diagnosis, three unfreezing depths were compared under the same cross-validation protocol.'],
      ['#congelamento-contexto', 'The network starts from ImageNet-pretrained weights; the question is how many final blocks to unfreeze for the medical-certificate domain. Three options entered the comparison: only the classifier head, the head plus the last feature block, and the head plus the last two feature blocks — the latter selected for delivery. Each ran under stratified 5-fold cross-validation over the 406 training images, up to 30 epochs with early stopping at a patience of 7, always with the same seed and the same class balancing.'],
      ...
      ['#congelamento-conclusao', 'The intermediate configuration, with only one block unfrozen, generalized worse and less consistently (74.9% ± 6.7%) than the current one with two blocks — unfreezing more did not make things worse, contradicting the natural suspicion that more trainable parameters would increase overfitting. The 27-point gap that triggered the initial alarm did not reappear in the 5-fold: there, between training and validation, it sat around 10 points for the current configuration — the difference came from the variance of a small test set, not real memorization. The selected architecture was confirmed, and the next quality gain depends on more data — especially the minority class, non-certificate — not on adjusting the unfreezing depth.'],
      ...
      ['#entrega .case-prose > .lead', 'The target machine was confirmed late: Intel HD 4600 integrated graphics and 8&nbsp;GB of RAM, with no dedicated GPU. The stack had been built assuming acceleration would be available, and the inference image started from a CUDA and cuDNN base — around 6&nbsp;GB of libraries that machine could never execute.'],
      ['#entrega .case-prose > p:nth-of-type(2)', 'Measuring before cutting showed that the weight lived in two different places, and the most visible one was not the most expensive. On <strong>disk</strong>, CUDA was the cost: large, inert libraries transported to the client only to never open. In <strong>memory</strong>, CUDA barely mattered — the operating system only loads code pages that execute. RAM was being consumed by something else: the face-recognition package loaded five models when the application queried two, and each server process loaded its own copy.'],
      ...
      ['#entrega .case-prose > p:nth-of-type(3)', 'The final stage changed the inference runtime: the model now runs on ONNX Runtime, which facial recognition already used, eliminating a second tensor framework from the delivery. Changing runtime, however, means changing the arithmetic that decides whether a medical certificate is accepted — and that required proof, not trust. The export script compares the new path against the old one over the entire test set and fails if any image changes sides: preprocessing was bit-for-bit identical, and no decision moved.'],
      ['#entrega .case-prose > p:nth-of-type(4)', 'The memory gain and the disk gain are not the same story, and treating them as one would have produced a pretty but false number. That is why both were measured and reported separately.'],
      ['#camada-errada .section-kicker', 'Interface diagnosis'],
      ['#camada-errada h2', 'Five defects that slipped through because verification looked at the wrong layer.'],
      ['#camada-errada .case-prose > .lead', 'A green test suite, reviewed code, a clean browser console — and five defects went through all of it. None was hard to fix; every one was hard to <em>see</em>, because the verification in use could not reach the layer they lived in.'],
      ...
      ['#camada-errada .case-prose > p:nth-of-type(2)', '<strong>The browser tab froze while the server sat idle.</strong> Containers below 1% CPU and no errors in 30 minutes already said the problem was on the client — not where. Biometric photos were served exactly as the camera produced them (4080&nbsp;×&nbsp;3060, 2.3&nbsp;MB) to fill 120&nbsp;px cards: each one becomes roughly 48&nbsp;MiB of bitmap in memory, and the <code>blob:</code> URLs created for them were never released. The suite tested that the endpoint returned the right photo with the right status, and would never have caught this: the defect was not in the behaviour, it was in the magnitude of what was returned.'],
      ...
      ['#camada-errada .case-formula p:nth-of-type(3)', 'Role gating ran correctly in JavaScript and CSS silently reverted it — restricted cards stayed visible to every role. The codebase already carried five patches written class by class, the signature of a hole being plugged case by case and escaping on the next class. The fix was a single general rule, plus a test that requires it in the stylesheets serving screens with access control.'],
      ['#camada-errada .case-list li:nth-child(1)', '<strong>Broken layout under HTTP 200 and a clean console:</strong> the container that puts menu and content side by side was missing, and the page collapsed into unstyled HTML. Page served, partials expanded, JavaScript raising nothing — all true, and none of it sees layout. Screenshotting a working page for comparison surfaced the bigger finding: two other screens had been broken the same way ever since they were extracted from the dashboard, with no one having recorded it.'],
      ['#camada-errada .case-list li:nth-child(2)', '<strong>An access rule displayed as a technical failure:</strong> viewing biometrics of an administrative account is restricted to the director, and the server answered 403 — correctly. The screen requested the photos anyway and printed “failed to load”, which made access policy look like an intermittent defect. The interface now knows the same rule, explains the restriction, and never issues a request doomed to 403.'],
      ['#camada-errada .case-list li:nth-child(3)', '<strong>The package shipping instructions from two releases back:</strong> the guide told the operator to open a directory the delivered package did not contain — anyone following it stalled on the first line. Every release gate passed, because they validated the working tree, not the copy inside the <code>tar</code>. Instructions now derive from a version variable, and verification moved to the extracted package.'],
      ['#camada-errada .case-prose > p:nth-of-type(3)', 'The pattern is the same in all five: each verification was valid and passed, and none had reach over the defect. Three fixes became automated tests in the same commit; the other two became habits — <strong>when the change is visual, screenshot the screen; when it is a delivery, open the box</strong> — which is the part that cannot be automated.'],
      ['#multi-stage .section-kicker', 'Delivery benchmark'],
      ['#multi-stage h2', 'The multi-stage gain, without changing the runtime.'],
      ['#multi-stage .case-prose > .lead', 'The total image reduction cannot be attributed to multi-stage without a controlled comparison. To isolate its effect, I built the same ONNX service — same code, model, and dependencies — in two versions: one installs everything directly in the final image; the other builds the environment in a build stage and copies only the runtime into the final stage.'],
      ...
      ['#multi-stage-conclusao', 'The 32.9 MiB are a real saving in the distributed artifact, but they do not alone explain the 94.6% historical reduction. The larger jump came from removing CUDA and PyTorch from inference. Separating the causes avoids turning a good engineering decision into a portfolio claim that is attractive but false.'],
      ['#progressao .section-kicker', 'Delivery trajectory'],
      ['#progressao h2', 'From 10.59&nbsp;GB to 1.11&nbsp;GB, in three separable decisions.'],
      ['#progressao .case-prose > .lead', 'Every release records in the manifest the exact size of the images it produced, which makes it possible to look at the whole delivery over time. And what shows up is not a single optimization effort: it is three decisions taken for different reasons, none of them with “shrink the image” as the main goal.'],
      ...
      ['#progressao-conclusao', 'Two readings the table supports and a general impression would not. First: the largest drop — the 7.6&nbsp;GB of inference — came from <strong>fitting the runtime to the real hardware</strong>, not from trimming layers; the second largest, from <strong>resolving a licensing blocker</strong> on the facial model, with the size reduction as a side effect. Second: from 1.0.10 onward the size does not move — the later releases changed behaviour, navigation and documentation, and a delivery that stops growing is as relevant a result as one that shrinks.'],
      ...
      ['#face-tech-intro', 'Protocols, baselines, benchmarks, and limitations supporting the case study. Each section starts with the decision and drills down to reproducible evidence.'],
      ...
      ['#reconhecimento-lead', 'Threshold, frame count, vector index, and model replacement looked independent. One shared instrument reproduced the kiosk pipeline and showed risk, cost without benefit, and premature complexity.'],
      ...
      ['#reconhecimento-concorrencia p:nth-child(3)', 'The detector and recognizer shared internal state in the thread pool. With 8 clock-ins, all 24 extractions failed. The fix was to serialize model access — the opposite of the parallelization the benchmark originally evaluated — and lock the behavior down with a regression test using 8 threads × 3 frames.'],
  ...
  'triple-roman': {
    ...
    content: [
      ...
      ['#trd-resumo-2', '<strong>My contribution:</strong> I implemented ant-colony and genetic-algorithm metaheuristics in C++ to investigate the problem.'],
      ['#trd-resumo-3', '<strong>The correction:</strong> the exact formulation published earlier accepts invalid solutions. I show the counterexample and propose a corrected formulation.'],
      ...
      ['#trd-card4-texto', 'The exact formulation in the literature accepted invalid distributions. I showed a counterexample and proposed a corrected formulation.'],
      ...
      ['#trd-destaque-texto', 'Beyond the metaheuristics implemented to investigate the problem, the work leaves a corrected exact formulation and a set of instances with optimal values already computed, which other research can use for comparison.'],
  ...
  'triple-roman-tecnico': {
    ...
    content: [
      ...
      ['#trdt-met-impacto-1', '<strong>Corrected exact formulation:</strong> the previously published ILP model accepts invalid solutions, and the text shows the counterexample that proves the flaw.'],
      ['#trdt-met-impacto-2', '<strong>Implemented metaheuristics:</strong> the work investigates the problem through genetic-algorithm and ant-colony approaches.'],
